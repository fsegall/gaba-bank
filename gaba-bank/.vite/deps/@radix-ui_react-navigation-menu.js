...
import { Presence } from "./chunk-5G6OBACF.js";
import {
...
import { Primitive, dispatchDiscreteCustomEvent } from "./chunk-LYY7VACZ.js";
import {
  composeRefs,
  require_jsx_runtime,
  useComposedRefs,
...
var NavigationMenu = React.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime.jsx)(NavigationMenuProvider, {
    ...
    children: (0, import_jsx_runtime.jsx)(Primitive.nav, {
      "aria-label": "Main",
...
var NavigationMenuList = React.forwardRef((props, forwardedRef) => {
  ...
  const list = (0, import_jsx_runtime.jsx)(Primitive.ul, {
...
var NavigationMenuLink = React.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime.jsx)(FocusGroupItem, {
    asChild: true,
    children: (0, import_jsx_runtime.jsx)(Primitive.a, {
      ...
      onClick: composeEventHandlers(
        ...
        (event) => {
          ...
          target.addEventListener(
            LINK_SELECT,
            (event2) => (onSelect == null ? void 0 : onSelect(event2)),
            { once: true },
          );
...
var NavigationMenuIndicatorImpl = React.forwardRef((props, forwardedRef) => {
  ...
  React.useEffect(() => {
    ...
    const triggerNode =
      (_a = items.find((item) => item.value === context.value)) == null
        ? void 0
        : _a.ref.current;
  ...
  return (0, import_jsx_runtime.jsx)(FocusGroup, {
    ...
    children: (0, import_jsx_runtime.jsx)(DismissableLayer, {
      ...
      onDismiss: () => {
        ...
        (_a = ref.current) == null
          ? void 0
          : _a.dispatchEvent(rootContentDismissEvent);
      },
      onFocusOutside: composeEventHandlers(props.onFocusOutside, (event) => {
        ...
        const target = event.target;
        if (
          (_a = context.rootNavigationMenu) == null
            ? void 0
            : _a.contains(target)
        )
          event.preventDefault();
      ...
      onPointerDownOutside: composeEventHandlers(
        ...
        (event) => {
          ...
          const isTrigger = getItems().some((item) => {
            var _a2;
            return (_a2 = item.ref.current) == null
              ? void 0
              : _a2.contains(target);
          });
          const isRootViewport =
            context.isRootMenu &&
            ((_a = context.viewport) == null ? void 0 : _a.contains(target));
...
var NavigationMenuViewportImpl = React.forwardRef((props, forwardedRef) => {
  ...
  const viewportWidth = size
    ? (size == null ? void 0 : size.width) + "px"
    : void 0;
  const viewportHeight = size
    ? (size == null ? void 0 : size.height) + "px"
    : void 0;
  const open = Boolean(context.value);
