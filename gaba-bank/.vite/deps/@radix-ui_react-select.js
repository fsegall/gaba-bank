...
import {
  ...
  hideOthers,
  useFocusGuards,
} from "./chunk-5AWFMF6A.js";
import {
  VISUALLY_HIDDEN_STYLES,
  createCollection,
  useDirection,
  usePrevious,
} from "./chunk-FJPLIKJG.js";
import { DismissableLayer, useCallbackRef } from "./chunk-KBXNKWKT.js";
import {
...
var Select = (props) => {
  ...
  const [nativeOptionsSet, setNativeOptionsSet] = React5.useState(
    /* @__PURE__ */ new Set(),
  );
  ...
  return (0, import_jsx_runtime3.jsx)(Root2, {
    ...popperScope,
    children: (0, import_jsx_runtime3.jsxs)(SelectProvider, {
      required,
      scope: __scopeSelect,
      trigger,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime3.jsx)(Collection.Provider, {
          scope: __scopeSelect,
          children: (0, import_jsx_runtime3.jsx)(SelectNativeOptionsProvider, {
        ...
        isFormControl
          ? (0, import_jsx_runtime3.jsxs)(
              SelectBubbleInput,
              {
                ...
                children: [
                  value === void 0
                    ? (0, import_jsx_runtime3.jsx)("option", { value: "" })
                    : null,
...
var SelectValue = React5.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    className,
    style,
  ...
  return (0, import_jsx_runtime3.jsx)(Primitive.span, {
    ...valueProps,
    ref: composedRefs,
...
var SelectIcon = React5.forwardRef((props, forwardedRef) => {
...
var SelectContent = React5.forwardRef((props, forwardedRef) => {
  ...
  if (!context.open) {
    ...
    return frag
      ? ReactDOM2.createPortal(
          (0, import_jsx_runtime3.jsx)(SelectContentProvider, {
            scope: props.__scopeSelect,
            children: (0, import_jsx_runtime3.jsx)(Collection.Slot, {
              scope: props.__scopeSelect,
  ...
  return (0, import_jsx_runtime3.jsx)(SelectContentImpl, {
    ...props,
    ref: forwardedRef,
  });
});
...
var [SelectContentProvider, useSelectContentContext] =
  createSelectContext(CONTENT_NAME2);
var CONTENT_IMPL_NAME = "SelectContentImpl";
var Slot = createSlot("SelectContent.RemoveScroll");
var SelectContentImpl = React5.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
  ...
  const [selectedItemText, setSelectedItemText] = React5.useState(null);
  const getItems = useCollection(__scopeSelect);
        ...
        pointerMoveDelta = {
          x: Math.abs(
            Math.round(event.pageX) -
              (((_a = triggerPointerDownPosRef.current) == null
                ? void 0
                : _a.x) ?? 0),
          ),
          y: Math.abs(
            Math.round(event.pageY) -
              (((_b = triggerPointerDownPosRef.current) == null
                ? void 0
                : _b.y) ?? 0),
          ),
        };
  ...
  const handleItemLeave = React5.useCallback(
  ...
  const popperContentProps =
    SelectPosition === SelectPopperPosition
      ...
      : {};
  return (0, import_jsx_runtime3.jsx)(SelectContentProvider, {
    scope: __scopeSelect,
    content,
    viewport,
    ...
    isPositioned,
    searchRef,
    children: (0, import_jsx_runtime3.jsx)(Combination_default, {
      as: Slot,
      allowPinchZoom: true,
      children: (0, import_jsx_runtime3.jsx)(FocusScope, {
        asChild: true,
        ...
        children: (0, import_jsx_runtime3.jsx)(DismissableLayer, {
          ...
          children: (0, import_jsx_runtime3.jsx)(SelectPosition, {
            role: "listbox",
...
var SelectItemAlignedPosition = React5.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime3.jsx)(SelectViewportProvider, {
    scope: __scopeSelect,
    contentWrapper,
...
var SelectViewport = React5.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, {
    children: [
      (0, import_jsx_runtime3.jsx)("style", {
        dangerouslySetInnerHTML: {
          __html: `[data-radix-select-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-select-viewport]::-webkit-scrollbar{display:none}`,
        },
        nonce,
      }),
      (0, import_jsx_runtime3.jsx)(Collection.Slot, {
        scope: __scopeSelect,
        children: (0, import_jsx_runtime3.jsx)(Primitive.div, {
...
var SelectGroup = React5.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, ...groupProps } = props;
  const groupId = useId();
  return (0, import_jsx_runtime3.jsx)(SelectGroupContextProvider, {
    scope: __scopeSelect,
    id: groupId,
    children: (0, import_jsx_runtime3.jsx)(Primitive.div, {
      role: "group",
...
var SelectLabel = React5.forwardRef((props, forwardedRef) => {
...
var SelectItem = React5.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    value,
    disabled = false,
  ...
  const composedRefs = useComposedRefs(forwardedRef, (node) => {
    var _a;
    return (_a = contentContext.itemRefCallback) == null
      ? void 0
      : _a.call(contentContext, node, value, disabled);
  });
  const textId = useId();
  const pointerTypeRef = React5.useRef("touch");
  const handleSelect = () => {
  ...
  return (0, import_jsx_runtime3.jsx)(SelectItemContextProvider, {
    scope: __scopeSelect,
    value,
    disabled,
    textId,
    ...
    onItemTextChange: React5.useCallback((node) => {
      setTextValue(
        (prevTextValue) =>
          prevTextValue ||
          ((node == null ? void 0 : node.textContent) ?? "").trim(),
      );
    }, []),
    children: (0, import_jsx_runtime3.jsx)(Collection.ItemSlot, {
      scope: __scopeSelect,
      value,
      disabled,
      textValue,
      children: (0, import_jsx_runtime3.jsx)(Primitive.div, {
        ...
        onPointerMove: composeEventHandlers(
          ...
          (event) => {
            ...
            pointerTypeRef.current = event.pointerType;
            if (disabled) {
              (_a = contentContext.onItemLeave) == null
                ? void 0
                : _a.call(contentContext);
        ...
        onKeyDown: composeEventHandlers(itemProps.onKeyDown, (event) => {
          var _a;
          const isTypingAhead =
            ((_a = contentContext.searchRef) == null ? void 0 : _a.current) !==
            "";
          if (isTypingAhead && event.key === " ") return;
...
var SelectItemText = React5.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = useComposedRefs(
    ...
    (node) => {
      var _a;
      return (_a = contentContext.itemTextRefCallback) == null
        ? void 0
        : _a.call(
            contentContext,
            node,
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, {
    children: [
      (0, import_jsx_runtime3.jsx)(Primitive.span, {
      ...
      !context.valueNodeHasChildren
        ? ReactDOM2.createPortal(itemTextProps.children, context.valueNode)
        : null,
    ],
  });
});
...
var SelectItemIndicator = React5.forwardRef((props, forwardedRef) => {
...
var SelectScrollUpButton = React5.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp
    ? (0, import_jsx_runtime3.jsx)(SelectScrollButtonImpl, {
        ...props,
        ref: composedRefs,
        onAutoScroll: () => {
...
var SelectScrollButtonImpl = React5.forwardRef((props, forwardedRef) => {
  ...
  useLayoutEffect2(() => {
    ...
    (_a = activeItem == null ? void 0 : activeItem.ref.current) == null
      ? void 0
...
var SelectSeparator = React5.forwardRef((props, forwardedRef) => {
...
var SelectArrow = React5.forwardRef((props, forwardedRef) => {
...
var SelectBubbleInput = React5.forwardRef(
  ({ __scopeSelect, value, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime3.jsx)(Primitive.select, {
      ...props,
